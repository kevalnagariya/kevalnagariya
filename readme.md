...
### 🧠 About Me
Hi, I’m a passionate **SFMC and Front-End Developer** who loves building clean, responsive, and user-friendly digital experiences.

I enjoy solving problems, learning new tools, and making ideas come to life through thoughtful design and code.
...
|----------|--------------|------------|
| [🧠 SFMC](https://github.com/kevalnagariya/SFMC) | Basics of AMPScript & SQL for SFMC |
...
#### 💻 Front-End
`HTML5` `CSS3` `JavaScript (ES6+)` `React.js` `jQuery` `Bootstrap` `Tailwind CSS` `Swiper.js`

#### 🧩 Backend & Database
`Node.js` `Express.js` `MongoDB` `Mongoose` `APIs` `MySQL` `WordPress` `PHP (Basics)`

#### ⚙️ Tools & Platforms
`Salesforce Marketing Cloud` `Git` `GitHub` `VS Code` `Netlify` `Figma` `Photopea` `Adobe Illustrator`
